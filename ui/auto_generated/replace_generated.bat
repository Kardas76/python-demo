pyside2-uic.exe --from-imports --output .\ui\auto_generated\ui_main.py .\ui\forms\ui_main.ui
...
pyside2-rcc.exe --output .\ui\auto_generated\files_rc.py .\ui\forms\files.qrc 
