...
class Widgets(object):
    ...
    def top(self, form):
        ...
        self.top_grip.setStyleSheet(u"background-color: rgba(85, 255, 255, 50);")
    ...
    def bottom(self, form):
        ...
        self.bottom_grip.setStyleSheet(u"background-color: rgba(85, 170, 0, 50);")
    ...
    def left(self, form):
        ...
        self.left_grip.setStyleSheet(u"background-color: rgba(255, 121, 198, 50);")
    ...
    def right(self, form):
        ...
        self.right_grip.setStyleSheet(u"background-color: rgba(255, 0, 127, 50);")
